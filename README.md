...
- [**#12** 인천항 컨테이너 터미널별 처리량, 220개월 중 39개월: 기준 셋을 다 못 넘었다 (2023-03~2026-07)](reports/report_12_터미널별_장기창.md)
  #11 이 예고한 대로 **수집기를 고쳐 같은 원천을 39개월로 다시 쟀다.** 창 41개월 / 관측 39 / 판정 불가 두 달. 기준 셋(S1 계절성·S2 쌍 동행·S3 몫의 단조성) **전부 FAIL** — 그리고 **셋 다 선커밋이 미리 적어 둔 귀무기대와 가까운 값**이었다. **기준마다 사전 난이도를 기준과 같이 커밋한 첫 편**이다.
