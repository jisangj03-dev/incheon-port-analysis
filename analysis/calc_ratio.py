...
#
#  분자(공컨) : container_2025.csv       - 인천항만공사 공컨 통계 API(15130235), 월별 TEU(정밀값)
...
print("=" * 55)
print("\n[연간 요약]")
print(f"  공컨 연간합계(분자) = {empty_year:,.0f} TEU  (공컨 API 15130235)")
...
# --- 6) 출처·정밀도 한계 명시 ---
print("\n[출처 및 정밀도 한계]")
print("  · 분자(공컨): 인천항만공사 공컨테이너 화물 통계 API(공공데이터포털 15130235), 월별 TEU")
